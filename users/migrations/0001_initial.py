    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(default='<Unk>', max_length=64)),
                ('username', models.CharField(max_length=128, unique=True)),
                ('password', models.CharField(max_length=128)),
                ('role', models.CharField(choices=[('admin', 'Администратор ОПГ'), ('member', 'Участиник ОПГ'), ('moderator', 'Смотрящий за ОПГ')], default='member', max_length=9)),
